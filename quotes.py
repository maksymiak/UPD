...
app.config['SQLALCHEMY_DATABASE_URI'] ='postgresql+psycopg2://pmaksymiak@db-fav-quotes:Ecg61str8!@db-fav-quotes.postgres.database.azure.com:5432/db-fav-quotes'
